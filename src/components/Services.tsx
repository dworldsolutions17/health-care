  ...
  const healthcareServices = [
    {
      ...
      title: 'Health Plans',
      description: "Affordable access to full-service healthcare. Families, individuals, corporates \u2014 we've covered you.",
    ...
    },
    {
      ...
      description: 'Detect risks early. Screen, manage, and prevent disease before symptoms show.',
    ...
    },
    {
      ...
      description: 'Get your health risk score in 3 minutes. Free. No spam. Doctor-reviewed logic.',
    ...
    },
    {
      ...
      description: 'Verified doctors, clinics, labs, and pharmacies in one trusted network.',
    ...
    },
    {
      ...
      description: 'For doctors and clinics who want patients who actually need them.',
